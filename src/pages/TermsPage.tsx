...
const TermsPage = () => (
  <LegalLayout title="Términos y Condiciones">
    ...
    <h2 className="font-heading font-bold text-xl text-foreground mt-6">1. Objeto</h2>
    ...
    <h2 className="font-heading font-bold text-xl text-foreground mt-6">2. Uso adecuado</h2>
    <p>El usuario se compromete a hacer un uso lícito de la web, sin ofender ni atentar contra terceros.</p>
    <h2 className="font-heading font-bold text-xl text-foreground mt-6">3. Propiedad intelectual</h2>
