...
const PrivacyPage = () => (
  <LegalLayout title="Política de Privacidad">
    ...
    <h2 className="font-heading font-bold text-xl mt-6">Responsable del tratamiento</h2>
    <p>{COMPANY.name} — Email: {COMPANY.email}</p>
    <h2 className="font-heading font-bold text-xl mt-6">Finalidad</h2>
    ...
    <h2 className="font-heading font-bold text-xl mt-6">Tus derechos</h2>
