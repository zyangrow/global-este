...
const CookiesPage = () => (
  <LegalLayout title="Política de Cookies">
    ...
    <h2 className="font-heading font-bold text-xl text-foreground mt-6">¿Qué son las cookies?</h2>
    <p>Las cookies son pequeños archivos que se almacenan en tu dispositivo cuando visitas una web.</p>
    <h2 className="font-heading font-bold text-xl text-foreground mt-6">Tipos de cookies que utilizamos</h2>
    <p>Cookies técnicas necesarias para el funcionamiento del sitio y cookies analíticas para entender cómo se usa la web.</p>
    <h2 className="font-heading font-bold text-xl text-foreground mt-6">Configuración</h2>
